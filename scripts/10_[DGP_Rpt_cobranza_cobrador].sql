...
if @intIdModoReporte = 0   
  ...
  FROM (  
   ...
   SELECT   
    ...
    isnull ( C2.NOMBRES , 'calle'  ) AS CONCEPTO ,     
   ...
   inner join dbo.Tb_Personal P ON A.IdPersonal = P.id_personal    

   LEFT JOIN dbo.Tb_Cliente_Proveedor C2 ON C2.ID_CLIENTE = A.idCliente   
   ...
   and A.Fecha BETWEEN @dtFechaInicial and @dtFechaFinal  
